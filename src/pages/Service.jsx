		...
		<>
			...
			<section className="bg-light">
				<div className="container py-5 text-center">
					<p className="display-6">Listo para entrar ?</p>
					<p className="text-muted">ahora visita este <NavLink className="text-decoration-none" to="/contact">Link</NavLink>, para poder atenderte en tu pedido!</p>
				</div>
			</section>
		</>
	);
