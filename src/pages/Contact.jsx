			...
			<div className="container row py-5 m-auto">
				<div className="col-md-6 d-flex align-items-center justify-content-center order-1">
					<form className="col-lg-8 col-12 col-md-10 text-center">
						...
						<button className="btn btn-lg btn_custom btn_shadow col-12">Enviar</button>
					</form>
				</div>
				...
				<div className="col-md-6 d-flex align-items-center order-lg-1 order-md-2 flex-column py-5">
					<div className="row col-12">
						<div className="col-md-6">
							<span className="lead mb-3">Soporte</span>
							<p className="small">
								...
								<span className="m-2 ml-0 hdrcolor"><LocationOnOutlinedIcon /></span>Guadalajara, Jalisco ,MXN
							</p>

						</div>
						<div className="col-md-6">
							<span className="lead mb-3">Ventas de produto</span>
